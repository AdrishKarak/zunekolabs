    ...
    erp: (
      <svg viewBox="0 0 480 200" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%' }}>
        ...
        {([[240,100,'HQ'],[100,50,'Plant A'],[380,50,'Plant B'],[80,150,'Finance'],[400,150,'HR'],[240,180,'Supply']] as [number,number,string][]).map(([x, y, label], i) => (
          <g key={i}>
            <circle cx={x} cy={y} r={i===0?22:14} fill={`rgba(0,232,122,${i===0?0.2:0.08})`} stroke={c} strokeWidth={i===0?1.5:1} opacity="0.9"/>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            color: 'var(--text-secondary)', border: '1px solid rgba(0,232,122,0.12)',
            background: 'rgba(3,13,7,0.7)', padding: '4px 10px',
        ...
        <div style={{ padding: '26px 28px 28px' }}>
          ...
          <div style={{
            ...
            paddingTop: '16px', borderTop: '1px solid rgba(0,232,122,0.08)',
          }}>
            <span style={{
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              background: 'rgba(6,26,14,0.9)', border: '1px solid var(--border-bright)',
