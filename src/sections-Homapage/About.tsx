  ...
  return (
    <motion.div
      ...
      whileHover={{
        ...
        boxShadow: '0 0 30px rgba(0,232,122,0.1)',
      }}
      style={{
...
export function About() {
  return (
    <section id="about" style={{
      ...
      padding: '120px 0',
      backgroundImage: 'repeating-linear-gradient(45deg, rgba(0,232,122,0.03) 0px, rgba(0,232,122,0.03) 1px, transparent 1px, transparent 40px)',
    }}>
      <div style={{
        maxWidth: '1152px',
        margin: '0 auto',
