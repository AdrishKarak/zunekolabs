...
function ParticleCanvas() {
  ...
  useEffect(() => {
    ...
    // ── 40 particles instead of 100 (cuts O(n²) work by 84%) ──
    ...
    const draw = () => {
      ...
      // ── draw dots only — no O(n²) line pass ──
      ...
      <div style={{
        ...
        <motion.div
          ...
          style={{
            ...
            border: '1px solid var(--border-bright)', background: 'rgba(0,232,122,0.08)',
        ...
        {/* CTA Buttons — plain CSS transitions, no whileHover */}
        <motion.div
        ...
        >
          ...
          <a
            ...
            style={{
              padding: '14px 32px', borderRadius: '6px',
              border: '1.5px solid rgba(240,250,244,0.3)', background: 'transparent',
            ...
            onMouseLeave={e => {
              (e.currentTarget as HTMLElement).style.borderColor = 'rgba(240,250,244,0.3)';
